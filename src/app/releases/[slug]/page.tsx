    ...
    <div className="max-w-screen-xl mx-auto px-6 md:px-12 py-20 md:py-28">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24 items-start">
        ...
        <div>
          ...
          {/* Tracklist */}
          {tracklist.length > 0 && (
            <div className="border-t border-stone-100 pt-6 mb-8 space-y-0">
              <p className="text-xs tracking-widest uppercase text-stone-400 mb-4">Tracklist</p>
              {tracklist.map((track, i) => (
                <div
                  key={i}
                  className="flex items-baseline gap-4 py-2.5 border-b border-stone-100 last:border-0"
                >
          ...
          {/* Credits */}
          {release.credits && (
            <p className="text-xs text-stone-400 leading-relaxed mt-10 pt-6 border-t border-stone-100">
              {release.credits}
            </p>
          )}
        </div>
